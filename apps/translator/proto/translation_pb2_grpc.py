...
class TranslationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Translate = channel.unary_unary(
                ...
                response_deserializer=proto_dot_translation__pb2.TranslationResponse.FromString,
...
def add_TranslationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Translate': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=proto_dot_translation__pb2.TranslationResponse.SerializeToString,
            ),
    }
...
class TranslationService(object):
    ...
    def Translate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            proto_dot_translation__pb2.TranslationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
